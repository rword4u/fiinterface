...
// Token settings
config.token = {
    secret: process.env.TOKEN_SECRET || 'FI-Interface',
...
// MongoDB settings
config.mongodb = {
    //dbURI: process.env.MONGODB_URI || process.env.MONGOLAB_URI || "mongodb://127.0.0.1:27017/FI-Interface-Db",
    dbURI: "mongodb://FI-Interface-DB:admin123@ds011024.mlab.com:11024/rakesh",
    dbOptions: {"user": "", "pass": ""}
};
